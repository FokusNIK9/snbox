...
if __name__ == "__main__":
    print("Selecting game object...")
    res_select = call_mcp("select_game_object", {"name": "Floor"})
    print(json.dumps(res_select, indent=2))
    
    print("\nGetting component properties...")
    res_props = call_mcp("get_component_properties", {"name": "Floor", "componentType": "ParticleBoxEmitter"})
    print(json.dumps(res_props, indent=2))
